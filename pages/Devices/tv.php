...
<html lang="en">
	...
	<div class="btn-group btn-breadcrumb">
		...
		<a href="tv.php" class="btn btn-default">TV & SMARTLIVING</a>
	</div>
		...
		<div class="panel panel-default">
			<div class="panel-body">
				...
				<div class="imagenWithButton" align="left">
					...
					$array = getDevice('16');
					?>
					<img class="img-noborder" src="../../php/getImageDevice.php?id=16" style="width:300px;height:250px" alt="Tv">
				</div>
			...
			<div class="panel-body">
				...
				<div class="imagenWithButton" align="left">
					...
					$array = getDevice('17');
					?>
					<img class="img-noborder" src="../../php/getImageDevice.php?id=17" style="width:300px;height:250px" alt="Watch">
				</div>
			...
			<div class="panel-body">
				...
				<div class="imagenWithButton" align="left">
					...
					$array = getDevice('18');
					?>
					<img class="img-noborder" src="../../php/getImageDevice.php?id=18" style="width:300px;height:250px" alt="Beats">
				</div>
			...
			<div class="panel-body">
				...
				<div class="imagenWithButton" align="left">
					...
					$array = getDevice('19');
					?>
					<img class="img-noborder" src="../../php/getImageDevice.php?id=19" style="width:300px;height:250px" alt="Gear">
				</div>
